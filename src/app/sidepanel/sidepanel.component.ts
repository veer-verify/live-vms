...
createGuardMasterData(){
  ...
  if(this.details?.item.siteId && this.alert && this.subalert && alertMessage && this.message  && this.alertField){
...
if(res.statusCode== 200){
  ...
  // this.templateDisplay=false;
this.alert=null;this.subalert=null;this.alertField1=null;this.currentSite=null;this.subAlertfield1=null;this.message=null;this.footer=null;
  this.colorpicker=null;this.deviceName=null;
  this.devicesList = [];
  // this.selectedFields=[];
}
})
...
createGuardEmailsData(){
  ...
  if(this.details?.item.siteName && this.timeSlots.length!=0 && this.selectedDays.length!=0 && this.to.length !== 0 ){
    ...
    if(res.statusCode== 200){
      ...
      this.startTime='00:00';this.endTime='00:00';
        ...
        this.alaram.snackSuccess("Please fill mandatory fields - days,startTime,endTime & mails");
      }
}
  ...
  contactNumber:any;
  contactName:any;
  bcc: string[] = ["vamsiv@ivisecurity.com","danielh@ivisecurity.com","nathanm@ivisecurity.com","dominicp@ivisecurity.com","guard@ivisecurity.com"];
  cc: string[] = [];
