...
export class CameraService {
  ...
  // public audio(payload: any): any {
  //   let url = `http://192.168.0.125:8000/audio/${payload.ip}/${payload.userName}/${payload.password}/${payload.id}`;
  ...
  screenshots(payload: any, file: any) {
    let url: string = `${environment.guard_monitoring_url}/screenshots_1_0`;
            // let url = `http://192.168.0.232:8953/guard/screenshots_1_0`;
  ...
  private getSecureToken(): string {
    const API_TOKEN = 'OjykxjAFrVn6KqBcppQI2ptAt4Dpf0RyWE0eUINs7WyqWXLrtUKr3iS1LPRem0TY0UtU43H3S4rtt300';
    if (!API_TOKEN) {
